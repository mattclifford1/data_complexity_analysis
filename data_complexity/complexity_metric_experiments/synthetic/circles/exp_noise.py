"""
Experiment: Effect of noise on circles dataset complexity.

The circles dataset creates two concentric circles.
Higher noise blurs the radial boundary between classes.
"""
import data_loaders
...
def run_experiment(noise_levels=None, plot_datasets=False, terminal_plot=True):
    """
    Run circles noise experiment.

    Parameters
    ----------
    noise_levels : list of float
        Noise standard deviations to test. Default: [0.02, 0.05, 0.1, 0.2]
    plot_datasets : bool
...
if __name__ == "__main__":
    print("Experiment: Circles Noise Effect on Complexity")
    print("=" * 50)
